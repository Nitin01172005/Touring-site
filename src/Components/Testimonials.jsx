...
const Testimonials = () => {
  return (
    ...
    initial={{opacity:0, x:100}}
      ...
      viewport={{once:true}}
    className=' mz-auto py-10 lg:px-32 w-full overflow-hidden' id='Testimonials'>
      ...
      <div className='flex flex-wrap justify-center gap-8'>
          {testimonialsData.map((testimonial, index)=>(
            <div key={index} className='max-w-[340px] border shadow-2xl rounded px-8 py-12 text-center'>
